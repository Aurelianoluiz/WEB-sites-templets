...
- Workflow de empacotamento final configurado para gerar ZIP e SHA-256.
- Verificação automática do ZIP contra `.env`, bancos, logs e outros artefatos sensíveis.
...
- Executar o workflow `CM Comercial Release Package` e validar o SHA-256 do ZIP gerado.
