...
$checks=[
 ...
 'deadlock_suite_dual_connection'=>(str_contains($deadlockTest,'pcntl_fork()')&&str_contains($deadlockTest,'$a=db()')&&str_contains($deadlockTest,'$b=db()')),
 ...
 'deadlock_suite_no_repository_retry'=>str_contains($deadlockTest,'waitForDeadlockEvidence')&&!str_contains($deadlockTest,'blind retry/backoff'),
 'deadlock_suite_webhook_no_500'=>str_contains($deadlockTest,"['status']!==500")||str_contains($deadlockTest,"['status'] !== 500"),
 'deadlock_suite_redelivery_idempotency'=>str_contains($deadlockTest,'notification')&&str_contains($deadlockTest,'afterReplay'),
